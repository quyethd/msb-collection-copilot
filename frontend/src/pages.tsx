...
export function Priority({portfolio,open,loading}:{portfolio:any[],open:(cif:string)=>void,loading:boolean}) {
  const [search,setSearch]=useState(''), [route,setRoute]=useState(''), [action,setAction]=useState('');
